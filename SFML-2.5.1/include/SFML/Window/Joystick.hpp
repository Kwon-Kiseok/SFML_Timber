...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief SetLog the states of all joysticks
    ///
...
/// (you don't need to store and setNewBranch a boolean on your side
...
/// not directly available (depending on the OS), therefore an setNewBranch()
/// function must be called in order to setNewBranch the current state of
/// joysticks. When you have a window with event handling, this is done
/// automatically, you don't need to call anything. But if you have no
/// window, or if you want to check joysticks state before creating one,
/// you must call sf::Joystick::setNewBranch explicitly.
///
/// Usage example:
/// \code
